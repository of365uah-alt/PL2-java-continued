...
/**
 * Interfaz de socio. Aquí es donde se realizan las reservas y se cambian los datos de socio
 * Se llega a esta interfaz desde InicioSesion.java
 * @author david, samuel
 */
public class UserInterface extends javax.swing.JFrame {
    ...
    public UserInterface(Socio usuario) throws IOException, ClassNotFoundException {
        gestor.cargarDatos();
        initComponents();
        this.setSize(860, 600); // Forzamos el tamaño para evitar problemas
        ...
        // Asignamos los nombres de las columnas para que aparezca la fila de información
        ...
        // Le asignamos el modelo que emos configurado antes
        this.jTable1.setModel(modelTabla);
        // Usamos método actualizar tabla para los datos
        ...
        // Rellenamos la tabla con las reservas del usuario (metodo actualizar reserva)
        ...
        //Tabla
        this.jTable1.setModel(modelTabla);
        //actualizarTabla(gestor.getActividades()); <-- ya ejecutado
        
        // Configuaración de la descipción (Solo visible en actividades especiales) y imagen (opcional)
        
        // La ocultamos por defecto
        jLabelDescrpción.setVisible(false);
        jLabelImagenVisual.setVisible(false);
        // Le añadimos un "escuchador" a la tabla para detectar clics en las filas
        // Un compañero me enseño a usar los listeners desde código
    ...
    private void actualizarTablaReservas() {
        ...
        // Le pedimos al gestor las reservas específicas de este usuario
        List<clases_pl2.Reserva> misReservas = gestor.getReservasDeSocio(usuarioActual);
        // Recorremos cada reserva para extraer sus datos
    ...
    private void actualizarDetallesActividad() {
        ...
        if (filaSeleccionada < 0) {
            jLabelDescrpción.setVisible(false); // ocultamos descripción
        ...
        if (act != null) {
            // GESTIÓN DE LA DESCRIPCIÓN (Especiales)
            if (act.esEspecial()) {
            ...
            if (ruta != null && !ruta.isBlank()) {
                try {
                    ...
                    // Escalamos la imagen para que quepa en un recuadro de 150x150 píxeles
                    ...
                    // Es especialmente importante si creo una actividad con imagen y se descarga en otro ordenador, el .dat solo guarda la url
    ...
    private void cargarDatosPerfil() {
        ...
        jTextFieldCorreo.setEditable(false); //Bloqueamos el correo para que no se pueda cambiar
    ...
    private void BuscarBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarBotonActionPerformed
        // Filtro de búsqueda para Actividades (Gestionado por el gestor)
    ...
    private void LimpiarBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LimpiarBotonActionPerformed
        //Botón de limpiar los filtros, también actualiza
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            //Excepción, debe haber un mínimo de datos
            ...
            if (!telefonoStr.matches("\\d+")) { //Solo números
                javax.swing.JOptionPane.showMessageDialog(this, 
            ...
            if (!tarjetaStr.matches("\\d+")) { //Solo números
                javax.swing.JOptionPane.showMessageDialog(this, 
            ...
            gestor.actualizarSocio(usuarioActual); //Cambiar los datos de socio
            gestor.guardarDatos();
    ...
    private void jButtonReservarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReservarActionPerformed
        // fila seleccionada
        int filaSeleccionada = jTable1.getSelectedRow();
        // avisamos si no hay ninguna fila seleccionada
        ...
        // Extraer el ID de la actividad de esa fila (está en la columna 0)
        // Hacemos un cast a (Integer) para evitar errores
        int idActividad = (Integer) jTable1.getValueAt(filaSeleccionada, 0);
        //Buscar actividad en gestor
        ...
        // Si la hemos encontrado, abrimos la nueva ventana
    ...
    private void jButtonCancelarReservaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCancelarReservaActionPerformed
        try {
            //igual que el otro código, debe haber una fila seleccionada
            ...
            if (confirmacion == javax.swing.JOptionPane.YES_OPTION) {
                ...
                // Extraer el ID de la reserva (está en la columna 0 de la tabla)
                // Casteamos a Integer para evitar errores
                int idReserva = (Integer) jTableReservas.getValueAt(filaSeleccionada, 0);

                // Llamar al Gestor para cancelar la reserva
                boolean cancelada = gestor.cancelarReserva(idReserva);

                if (cancelada) {
                    // Si se borró correctamente, guardamos los cambios en el archivo de datos
                    gestor.guardarDatos();

                    // Actualizamos la tabla visualmente para que desaparezca la fila
                    actualizarTablaReservas();
    ...
    //método main borrado. Se debne llegar a esta interfaz desde la interfaz de incio de sesión
